...
import { numBeToBytes, numFrom, numFromBytes, numToBytes, numToHex, } from "../num/index.js";
...
export function epochToHex(epochLike) {
    ...
    return hexFrom(bytesConcat(numBeToBytes(epoch[2], 2), numBeToBytes(epoch[1], 2), numBeToBytes(epoch[0], 3)));
}
/**
 * @public
 */
